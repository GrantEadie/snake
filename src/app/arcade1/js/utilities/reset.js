...
export const reset = (p5, canvas) => {
  ...
  for (let i = 0; i < 3; i++) {
    state.doorTrigger[i] = new Border(p5, 99, i * 2 + 47, 0, 2);
  }
  for (let i = 0; i < 23; i++) {
    state.rightBorderBottom[i] = new Border(p5, 99, i * 2 + 53, 0, 2);
  }
  for (let i = 0; i < 50; i++) {
  ...
  for (let i = 0; i < 23; i++) {
    state.leftBorderBottom[i] = new Border(p5, 1, i * 2 + 53, 0, 2);
  }
